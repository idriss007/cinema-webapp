...
const AddToList = async (req, res) => {
    ...
    if (!list_id || !movieData) { return res.sendStatus(400); }
    ...
    try {
        ...
        const isContain = list.movies.find(movie => movie.movie.id === movieData.id);
...
const RemoveFromList = async (req, res) => {
    ...
    if (!list_id || !movieData) { return res.send(400); }
    ...
    try {
        ...
        const filteredlist = list.movies.filter(movie => movie.movie.id !== movieData.id);
