...
function PersonDetail() {
    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            const sortedCastCredits = credits?.cast?.sort((a, b) => { return a.order - b.order || b.vote_count - a.vote_count });
            const sortedCrewCredits = credits?.crew?.sort((a, b) => { return a.order - b.order || b.vote_count - a.vote_count });
    ...
    return (
        <div className={styles.container}>
            <div className={styles.gridContainer} >
                ...
                {personCredits && <div className={styles.credit + " " + styles.gridColAll}><MovieSlider movies={personCredits}>Yer Aldığı Yapımlar</MovieSlider></div>}
