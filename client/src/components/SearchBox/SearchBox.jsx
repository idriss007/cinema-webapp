...
function SearchBox({handleKeyPress, handleChange, searchQuery, placeholder, movies, linkStyle, imgPath}) {
    
    return (
        <>
            <div className={styles.searchInputs}>
                <input onKeyDown={handleKeyPress} value={searchQuery} onChange={handleChange} className={styles.searchBoxInput} placeholder={placeholder} />
            </div>
