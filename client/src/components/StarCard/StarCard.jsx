    ...
    return (
        <>
            <button
                ...
                {ratedValue ? <p className={styles.ratingBtnTxt}>{ratedValue}/10</p> : (<BsStar size="30" />)}
            </button>

            <Modal centered show={show} onHide={handleClose}>
                <Modal.Header className={styles.container}>
                    <Modal.Title className={styles.modalRatingTxt}>{rating ? rating : "Puanla"}</Modal.Title>
                </Modal.Header>
                ...
                <Modal.Footer className={styles.container}>
                    {(ratedValue || rating) && (<Button className="btn btn-danger" variant="secondary" onClick={() => {
                        if (loggedIn) {
                    ...
                    {rating && (<Button variant="primary" onClick={() => {
                        if (loggedIn) {
